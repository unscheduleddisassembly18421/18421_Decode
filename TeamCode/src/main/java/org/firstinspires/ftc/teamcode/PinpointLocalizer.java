...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -3349.83185683789; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1056.2631903056292; // x position of the perpendicular encoder (in tick units)
    }
