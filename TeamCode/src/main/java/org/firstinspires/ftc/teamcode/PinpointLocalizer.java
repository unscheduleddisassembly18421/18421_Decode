...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3394.5099569280283; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1087.0406112494838; // x position of the perpendicular encoder (in tick units)
    }
